            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-primary">
                    <div class="card-body card-body pb-0 d-flex justify-content-between align-items-start">
                        ...
                        <div class="btn-group">
                            <button class="btn btn-transparent dropdown-toggle p-0" type="button" data-toggle="dropdown"
                                ...
                                <svg class="c-icon">
                                    <use xlink:href="{{asset('svg_sprites/free.svg#cil-settings')}}"></use>
                                </svg>
                            </button>
                    ...
                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart1" style="display: block;"
                            width="340" height="70"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-info">
                    ...
                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart2" style="display: block;"
                            width="340" height="70"></canvas>
                        <div id="card-chart2-tooltip" class="c-chartjs-tooltip top"
                            style="opacity: 0; left: 187px; top: 117.979px;">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-warning">
                    ...
                    <div class="c-chart-wrapper mt-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart3" style="display: block;"
                            width="372" height="70"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-danger">
                    ...
                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart4" style="display: block;"
                            width="340" height="70"></canvas>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                        ...
                        <button class="btn btn-primary" type="button">
                            <svg class="c-icon">
                                <use xlink:href="{{asset('svg_sprites/free.svg#cil-cloud-download')}}"></use>
                            </svg>
                        </button>
                    </div>
                </div>
                <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                    ...
                    <canvas class="chart chartjs-render-monitor" id="main-chart" style="display: block;" width="1545"
                        height="300"></canvas>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header bg-facebook content-center">
                        <svg class="c-icon c-icon-3xl text-white my-4">
                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-facebook-f')}}"></use>
                        </svg>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="card">
                    <div class="card-header bg-twitter content-center">
                        <svg class="c-icon c-icon-3xl text-white my-4">
                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-twitter')}}"></use>
                        </svg>
                    </div>
                    <div class="card-body row text-center">
                        <div class="col">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="card">
                    <div class="card-header bg-linkedin content-center">
                        <svg class="c-icon c-icon-3xl text-white my-4">
                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-linkedin')}}"></use>
                        </svg>
                    </div>
                    <div class="card-body row text-center">
                        <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="progress-group mb-5">
                                    <div class="progress-group-header">
                                        <svg class="c-icon progress-group-icon">
                                            <use xlink:href="{{asset('svg_sprites/free.svg#cil-user-female')}}"></use>
                                        </svg>
                                        <div>Female</div>
                                ...
                                <div class="progress-group">
                                    <div class="progress-group-header align-items-end">
                                        <svg class="c-icon progress-group-icon">
                                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-google')}}"></use>
                                        </svg>
                        ...
                        <table class="table table-responsive-sm table-hover table-outline mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/flag.svg#cif-us')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-cc-mastercard')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/flag.svg#cif-br')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-cc-visa')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/flag.svg#cif-in')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-cc-stripe')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/flag.svg#cif-fr')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-cc-paypal')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/flag.svg#cif-es')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-cc-apple-pay')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/flag.svg#cif-pl')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="{{asset('svg_sprites/brand.svg#cib-cc-amex')}}"></use>
                                        </svg>
                                    </td>
                                    <td>
